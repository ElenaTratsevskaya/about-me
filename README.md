...
<span style="color:#696969">**H A R D S K I L S**</span><br>
**BI:** Power BI, DAX, Power Query, M<br>
**SQL / DWH:** PostgreSQL, ETL, витрины, модели<br>
**Python:** Pandas, NumPy, Matplotlib<br>
**Интеграции:** API, файлы, автообновление, семантические модели<br>
**Аналитика и документация:** ТЗ, инструкции, регламенты<br>
**Инструменты:** Excel, Google Sheets, Figma<br><br>
